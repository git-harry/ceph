...
OPTION(filestore_max_inline_xattr_size_btrfs, OPT_U32, 4096)
...
OPTION(filestore_max_inline_xattrs_xfs, OPT_U32, 2)
OPTION(filestore_max_inline_xattrs_btrfs, OPT_U32, 2)
